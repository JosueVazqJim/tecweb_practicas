...
<?php
    ...
    if (!empty($tope))
    {
        ...
        if ( $result = $link->query("SELECT * FROM productos_2 WHERE unidades <= $tope") ) 
        {
...
<body>
    ...
    <script>
            function send2form(nombre, marcas, modelo, precio, unidades, detalles, imagen) {
                ...
                form.method = 'POST';
                form.action = "http://localhost/tecweb_practicas_pc/practicas/p07-base/formulario_productos_v2.php";
