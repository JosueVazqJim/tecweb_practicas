...
$contact = $dom->getElementsByTagName('contact')->item(0); //almacena solo lo que tiene el primer nodo contact

$extra = $dom->createElement('extra');
$extra = $contact->appendChild($extra); // se anexa el elemento 'extra' a 'contactinfo'
